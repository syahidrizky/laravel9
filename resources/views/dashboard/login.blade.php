...
<div class="container d-flex justify-content-center align-items-center mt-5">
    <form method="POST" action="{{route('login.auth')}}" class="card py-4 px-4">
        ...
        <span class="info-text">Please fill in your username and password to login</span>
        ...
        <div class=" mt-5 d-flex justify-content-between align-items-center">
            <span><a href="{{route('register')}}" style="text-decoration: underline;">Don't have an account ?</a></span>
